<?php function post_story_full($args){
global $post;
ob_start();
...
<h2 class="home-title uk-heading-divider"><img src="/wp-content/themes/pntoday/image/full-label.png" width="30" style="vertical-align: text-bottom;"/> Truyện Full</h2><a href="/full/" class="uk-icon-link home-read-more" uk-icon="triangle-right">Xem thêm</a>
...
add_shortcode('post_story_full','post_story_full');
?>
