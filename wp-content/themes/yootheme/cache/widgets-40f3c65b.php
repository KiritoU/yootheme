<?php // $file = /usr/local/lsws/animesuge.xyz/html/wp-content/themes/yootheme/vendor/yootheme/theme-wordpress-widgets/config/widgets.json
...
return [
  'fields' => [
    ...
    'style' => [
      ...
      'show' => '$match(this.position, "^(top|bottom|sidebar|builder-\\d+)$")'
    ], 
    'title_style' => [
      'label' => 'Title Style', 
      ...
      'show' => '$match(this.position, "^(top|bottom|sidebar|dialog|mobile|builder-\\d+)$")'
    ], 
    'title_decoration' => [
    ...
    'text_align_breakpoint' => [
      ...
      'show' => '$match(this.position, "^(top|bottom|sidebar|dialog|mobile|builder-\\d+)$") && text_align && text_align != "justify"'
    ], 
    'text_align_fallback' => [
      ...
      'show' => '$match(this.position, "^(top|bottom|sidebar|dialog|mobile|builder-\\d+)$") && text_align && text_align != "justify" && text_align_breakpoint'
    ], 
    'width' => [
      'label' => 'Width', 
