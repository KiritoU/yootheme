<?php // $file = /usr/local/lsws/animesuge.xyz/html/wp-content/themes/yootheme/vendor/yootheme/builder/elements/row/element.json
  ...
  'fieldset' => [
    'default' => [
      ...
      'fields' => [[
          ...
          'title' => 'Advanced', 
          'fields' => ['status', 'id', 'class', 'attributes', 'css']
        ]]
    ]
  ], 
  'panels' => [
