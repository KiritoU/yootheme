<?php // $file = /usr/local/lsws/animesuge.xyz/html/wp-content/themes/yootheme/vendor/yootheme/builder-wordpress/elements/module/element.json
...
return [
  ...
  'fields' => [
    ...
    'menu_divider' => [
      ...
      'type' => 'checkbox', 
      'text' => 'Show dividers', 
      'enable' => '(menu_type == \'nav\' || menu_type == \'subnav\') && $match(type, \'menu\')'
    ], 
    'menu_style' => [
      'label' => 'Style', 
