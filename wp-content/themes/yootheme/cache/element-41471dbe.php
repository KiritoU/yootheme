<?php // $file = /usr/local/lsws/animesuge.xyz/html/wp-content/themes/yootheme/vendor/yootheme/builder/elements/overlay/element.json
...
return [
  ...
  'fields' => [
    ...
    'css' => [
      'label' => 'CSS', 
      'description' => 'Enter your own custom CSS. The following selectors will be prefixed automatically for this element: <code>.el-element</code>, <code>.el-image</code>, <code>.el-title</code>, <code>.el-meta</code>, <code>.el-content</code>, <code>.el-hover-image</code>, <code>.el-container</code>, <code>.el-overlay</code>', 
      'type' => 'editor', 
      'editor' => 'code', 
      'mode' => 'css', 
      'attrs' => [
        'debounce' => 500, 
        'hints' => ['.el-element', '.el-image', '.el-title', '.el-meta', '.el-content', '.el-hover-image', '.el-container', '.el-overlay']
      ]
    ]
  ], 
  'fieldset' => [
    'default' => [
      ...
      'fields' => [[
          ...
          'fields' => [[
              ...
              'type' => 'group', 
              'divider' => true, 
              'fields' => ['image_transition', 'image_transition_border', 'image_min_height', 'image_border', 'image_box_shadow', 'image_hover_box_shadow', 'image_box_decoration', 'image_box_decoration_inverse', 'image_loading']
            ], [
              'label' => 'Title', 
              'type' => 'group', 
              'divider' => true, 
