<?php // $file = /usr/local/lsws/animesuge.xyz/html/wp-content/themes/yootheme/vendor/yootheme/builder/elements/section/element.json
  ...
  'fieldset' => [
    'default' => [
      ...
      'fields' => [[
          ...
          'title' => 'Settings', 
          'fields' => ['style', 'preserve_color', 'overlap', 'text_color', 'width', 'padding_remove_horizontal', 'width_expand', 'height', 'vertical_align', 'padding', 'padding_remove_top', 'padding_remove_bottom', 'sticky', 'header_transparent', 'header_transparent_noplaceholder', 'animation', 'animation_delay', [
              'label' => 'Title', 
              'type' => 'group', 
      ...
      'fieldset' => [
        'default' => [
          'fields' => [[
            ...
            ], 'image_loading', 'image_size', 'image_position', 'image_effect', 'image_parallax_bgx', 'image_parallax_bgy', 'image_parallax_easing', 'image_parallax_breakpoint', [
