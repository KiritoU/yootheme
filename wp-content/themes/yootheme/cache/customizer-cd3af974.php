<?php // $file = /usr/local/lsws/animesuge.xyz/html/wp-content/themes/yootheme/vendor/yootheme/theme-settings/config/customizer.json
    ...
    'advanced' => [
      ...
      'fields' => [
        'webp' => [
          ...
          'text' => 'Serve images in WebP format', 
          'type' => 'checkbox'
        ], 
        'avif' => [
          'description' => 'Serve optimized images in formats with better compression and quality than JPEG and PNG. Disable both options to preserve the IPTC Photo Metadata of JPEG images. Mind that this will slow down loading times.', 
          'text' => 'Serve images in AVIF format', 
          'type' => 'checkbox'
        ], 
        'jquery' => [
          'label' => 'jQuery', 
