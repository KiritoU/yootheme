<?php // $file = /usr/local/lsws/animesuge.xyz/html/wp-content/themes/yootheme/vendor/yootheme/builder/elements/text/element.json
    ...
    'default' => [
      ...
      'fields' => [[
          ...
          'fields' => [[
              ...
              'type' => 'group', 
              'divider' => true, 
              'fields' => ['dropcap', 'text_style', 'text_color', 'column', 'column_divider', 'column_breakpoint']
            ], [
              'label' => 'General', 
              'type' => 'group', 
