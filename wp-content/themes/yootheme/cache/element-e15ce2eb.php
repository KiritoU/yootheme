<?php // $file = /usr/local/lsws/animesuge.xyz/html/wp-content/themes/yootheme/vendor/yootheme/builder/elements/social/element.json
    ...
    'default' => [
      ...
      'fields' => [[
          ...
          'fields' => [[
              ...
              'type' => 'group', 
              'divider' => true, 
              'fields' => ['link_style', 'icon_width', 'image_loading', 'grid', 'grid_vertical_breakpoint', 'grid_gap', 'link_target']
            ], [
              'label' => 'General', 
              'type' => 'group', 
