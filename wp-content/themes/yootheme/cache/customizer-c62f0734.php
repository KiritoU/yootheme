<?php // $file = /usr/local/lsws/animesuge.xyz/html/wp-content/themes/yootheme/vendor/yootheme/builder/config/customizer.json
    ...
    'builder-parallax' => [
      ...
      'fields' => [
        ...
        'parallax_transform_origin' => [
          ...
          'description' => 'Define the origin of the element\'s transformation.', 
          'type' => 'select', 
          'options' => [
            'Top Left' => 'top-left', 
