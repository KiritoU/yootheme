...
export const Sticky = {
    ...
    update: {
        read() {
            ...
            return {
                start:
                    // clientHeight is constant on mobile devices ( => 100 svh). 80 seems to be biggest menubar on mobile devices. clientHeight + 80 ~= 100vh
                    this.section.offsetHeight <= document.documentElement.clientHeight + 80
