...
class SourceQuery
{
    ...
    public function queryField($field, Node $node)
    {
        ...
        $arguments = isset($field->arguments) ? (array) $field->arguments : [];
        $directives = isset($field->directives) ? (array) $field->directives : [];
        ...
        foreach ($directives as $directive) {
            $node->directive(
                $directive->name,
                isset($directive->arguments) ? (array) $directive->arguments : []
            );
        }
