...
<h2 class="home-title uk-heading-divider"><img src="/wp-content/themes/pntoday/image/new-2.png" width="30" style="vertical-align: text-bottom;"/> Truyện Mới </h2><a href="/moi-cap-nhat/" class="uk-icon-link home-read-more" uk-icon="triangle-right">Xem thêm</a>
...
add_shortcode('post_story','post_story');
?>
