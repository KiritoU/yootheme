...
$rocket_path        = '/usr/local/lsws/mrworldpremiere.wf/html/wp-content/plugins/wp-rocket/';
$rocket_config_path = '/usr/local/lsws/mrworldpremiere.wf/html/wp-content/wp-rocket-config/';
$rocket_cache_path  = '/usr/local/lsws/mrworldpremiere.wf/html/wp-content/cache/wp-rocket/';
...
if ( file_exists( '/usr/local/lsws/mrworldpremiere.wf/html/wp-content/plugins/wp-rocket/inc/classes/dependencies/mobiledetect/mobiledetectlib/Mobile_Detect.php' ) && ! class_exists( 'WP_Rocket_Mobile_Detect' ) ) {
	include_once '/usr/local/lsws/mrworldpremiere.wf/html/wp-content/plugins/wp-rocket/inc/classes/dependencies/mobiledetect/mobiledetectlib/Mobile_Detect.php';
}
