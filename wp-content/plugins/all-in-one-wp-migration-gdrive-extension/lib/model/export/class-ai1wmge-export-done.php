...
class Ai1wmge_Export_Done {
	...
	public static function execute( $params ) {
		...
		Ai1wm_Notification::ok(
			...
			sprintf( __( '<p>Date: %s</p>', AI1WMGE_PLUGIN_NAME ), date_i18n( 'r' ) ) .
			sprintf( __( '<p>Backup file: %s</p>', AI1WMGE_PLUGIN_NAME ), ai1wm_archive_name( $params ) ) .
			sprintf( __( '<p>Backup type: %s</p>', AI1WMGE_PLUGIN_NAME ), ( ai1wmge_is_incremental() ? __( 'Incremental', AI1WMGE_PLUGIN_NAME ) : __( 'Full', AI1WMGE_PLUGIN_NAME ) ) ) .
